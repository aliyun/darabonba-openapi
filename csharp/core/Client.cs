    ...
    public class Client 
    {
        ...
        public Dictionary<string, object> DoRPCRequest(string action, string version, string protocol, string method, string authType, string bodyType, OpenApiRequest request, Darabonba.Models.RuntimeOptions runtime)
        {
            ...
            while (Darabonba.Core.ShouldRetry((Darabonba.RetryPolicy.RetryOptions)runtime_["retryOptions"], _retryPolicyContext))
            {
                ...
                {
                    backoffTime = Darabonba.Core.GetBackoffDelay((Darabonba.RetryPolicy.RetryOptions)runtime_["retryOptions"], _retryPolicyContext);
                    if (backoffTime > 0)
                    {
                ...
                try
                {
                    ...
                    Utils.ApplyRetryHeaders(request_.Headers, _retriesAttempted, backoffTime);
        ...
        // Hand-written (not generated by darabonba): yield cannot live in catch; keep across codegen.
        /// <summary>
        /// Call SSE API asynchronously. Available when DARA_ASYNC_ENUMERABLES_API is defined
        /// (non-.NET Framework TFMs; netstandard2.0 via Microsoft.Bcl.AsyncInterfaces).
        /// </summary>
