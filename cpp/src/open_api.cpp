...
map<string, boost::any> Alibabacloud_OpenApi::Client::doRPCRequest(shared_ptr<string> action,
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      shared_ptr<map<string, string>> headers = make_shared<map<string, string>>(getRpcHeaders());
      ...
      if (Darabonba_Util::Client::is4xx(make_shared<int>(response_->statusCode)) || Darabonba_Util::Client::is5xx(make_shared<int>(response_->statusCode))) {
        ...
        shared_ptr<boost::any> requestId = make_shared<boost::any>(Client::defaultAny(make_shared<boost::any>((*err)["RequestId"]), make_shared<boost::any>((*err)["requestId"])));
        BOOST_THROW_EXCEPTION(Darabonba::Error(map<string, boost::any>({
          ...
          {"message", boost::any(string("code: ") + string(boost::lexical_cast<string>(response_->statusCode)) + string(", ") + string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["Message"]), make_shared<boost::any>((*err)["message"])))) + string(" request id: ") + string(Darabonba::Converter::toString(requestId)))},
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      if (!Darabonba_Util::Client::equalString(authType, make_shared<string>("Anonymous"))) {
        ...
        request_->headers.insert(pair<string, string>("authorization", string("acs ") + string(*accessKeyId) + string(":") + string(Alibabacloud_OpenApiUtil::Client::getROASignature(stringToSign, accessKeySecret))));
      }
      _lastRequest = request_;
      shared_ptr<Darabonba::Response> response_ = make_shared<Darabonba::Response>(Darabonba::Core::doAction(request_, runtime_));
      ...
      if (Darabonba_Util::Client::is4xx(make_shared<int>(response_->statusCode)) || Darabonba_Util::Client::is5xx(make_shared<int>(response_->statusCode))) {
        ...
        shared_ptr<map<string, boost::any>> err = make_shared<map<string, boost::any>>(Darabonba_Util::Client::assertAsMap(_res));
        shared_ptr<boost::any> requestId = make_shared<boost::any>(Client::defaultAny(make_shared<boost::any>((*err)["RequestId"]), make_shared<boost::any>((*err)["requestId"])));
        requestId = make_shared<boost::any>(Client::defaultAny(requestId, make_shared<boost::any>((*err)["requestid"])));
        BOOST_THROW_EXCEPTION(Darabonba::Error(map<string, boost::any>({
          {"code", boost::any(string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["Code"]), make_shared<boost::any>((*err)["code"])))))},
          {"message", boost::any(string("code: ") + string(boost::lexical_cast<string>(response_->statusCode)) + string(", ") + string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["Message"]), make_shared<boost::any>((*err)["message"])))) + string(" request id: ") + string(Darabonba::Converter::toString(requestId)))},
          {"data", !err ? boost::any() : boost::any(*err)}
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      ...
      if (Darabonba_Util::Client::is4xx(make_shared<int>(response_->statusCode)) || Darabonba_Util::Client::is5xx(make_shared<int>(response_->statusCode))) {
        ...
        BOOST_THROW_EXCEPTION(Darabonba::Error(map<string, boost::any>({
          {"code", boost::any(string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["Code"]), make_shared<boost::any>((*err)["code"])))))},
          {"message", boost::any(string("code: ") + string(boost::lexical_cast<string>(response_->statusCode)) + string(", ") + string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["Message"]), make_shared<boost::any>((*err)["message"])))) + string(" request id: ") + string(Darabonba::Converter::toString(Client::defaultAny(make_shared<boost::any>((*err)["RequestId"]), make_shared<boost::any>((*err)["requestId"])))))},
          {"data", !err ? boost::any() : boost::any(*err)}
        })));
      }
      if (Darabonba_Util::Client::equalString(bodyType, make_shared<string>("binary"))) {
...
map<string, boost::any> Alibabacloud_OpenApi::Client::doRequest(shared_ptr<Params> params, shared_ptr<OpenApiRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  params->validate();
  request->validate();
  runtime->validate();
  shared_ptr<map<string, boost::any>> runtime_ = make_shared<map<string, boost::any>>(map<string, boost::any>({
  ...
  while (Darabonba::Core::allowRetry(make_shared<boost::any>((*runtime_)["retry"]), _retryTimes, _now)) {
    ...
    try {
      shared_ptr<Darabonba::Request> request_ = make_shared<Darabonba::Request>();
      request_->protocol = Darabonba_Util::Client::defaultString(_protocol, params->protocol);
      request_->method = *params->method;
      request_->pathname = Alibabacloud_OpenApiUtil::Client::getEncodePath(params->pathname);
      request_->query = *request->query;
      // endpoint is setted in product client
      request_->headers = Darabonba::Converter::merge(map<string, string>({
        {"host", !_endpoint ? string() : *_endpoint},
        {"x-acs-version", !params->version ? string() : *params->version},
      ...
      shared_ptr<string> signatureAlgorithm = make_shared<string>(Darabonba_Util::Client::defaultString(_signatureAlgorithm, make_shared<string>("ACS3-HMAC-SHA256")));
      shared_ptr<string> hashedRequestPayload = make_shared<string>(Alibabacloud_OpenApiUtil::Client::hexEncode(make_shared<vector<uint8_t>>(Alibabacloud_OpenApiUtil::Client::hash(make_shared<vector<uint8_t>>(Darabonba_Util::Client::toBytes(make_shared<string>(""))), signatureAlgorithm))));
      if (!Darabonba_Util::Client::isUnset<boost::any>(request->body)) {
        if (Darabonba_Util::Client::equalString(params->reqBodyType, make_shared<string>("json"))) {
          shared_ptr<string> jsonObj = make_shared<string>(Darabonba_Util::Client::toJSONString(request->body));
          hashedRequestPayload = make_shared<string>(Alibabacloud_OpenApiUtil::Client::hexEncode(make_shared<vector<uint8_t>>(Alibabacloud_OpenApiUtil::Client::hash(make_shared<vector<uint8_t>>(Darabonba_Util::Client::toBytes(jsonObj)), signatureAlgorithm))));
          request_->body = Darabonba::Converter::toStream(*jsonObj);
        }
        else {
          shared_ptr<map<string, boost::any>> m = make_shared<map<string, boost::any>>(Darabonba_Util::Client::assertAsMap(request->body));
          shared_ptr<string> formObj = make_shared<string>(Alibabacloud_OpenApiUtil::Client::toForm(m));
          hashedRequestPayload = make_shared<string>(Alibabacloud_OpenApiUtil::Client::hexEncode(make_shared<vector<uint8_t>>(Alibabacloud_OpenApiUtil::Client::hash(make_shared<vector<uint8_t>>(Darabonba_Util::Client::toBytes(formObj)), signatureAlgorithm))));
          request_->body = Darabonba::Converter::toStream(*formObj);
          request_->headers.insert(pair<string, string>("content-type", "application/x-www-form-urlencoded"));
        }
      }
      if (!Darabonba_Util::Client::isUnset<Darabonba::Stream>(request->stream)) {
        shared_ptr<vector<uint8_t>> tmp = make_shared<vector<uint8_t>>(Darabonba_Util::Client::readAsBytes(request->stream));
        hashedRequestPayload = make_shared<string>(Alibabacloud_OpenApiUtil::Client::hexEncode(make_shared<vector<uint8_t>>(Alibabacloud_OpenApiUtil::Client::hash(tmp, signatureAlgorithm))));
        request_->body = Darabonba::Converter::toStream(*tmp);
      }
      request_->headers.insert(pair<string, string>("x-acs-content-sha256", *hashedRequestPayload));
      if (!Darabonba_Util::Client::equalString(params->authType, make_shared<string>("Anonymous"))) {
        shared_ptr<string> accessKeyId = make_shared<string>(getAccessKeyId());
        shared_ptr<string> accessKeySecret = make_shared<string>(getAccessKeySecret());
        shared_ptr<string> securityToken = make_shared<string>(getSecurityToken());
        if (!Darabonba_Util::Client::empty(securityToken)) {
        ...
        request_->headers.insert(pair<string, string>("Authorization", Alibabacloud_OpenApiUtil::Client::getAuthorization(request_, signatureAlgorithm, hashedRequestPayload, accessKeyId, accessKeySecret)));
      }
      _lastRequest = request_;
      shared_ptr<Darabonba::Response> response_ = make_shared<Darabonba::Response>(Darabonba::Core::doAction(request_, runtime_));
      if (Darabonba_Util::Client::is4xx(make_shared<int>(response_->statusCode)) || Darabonba_Util::Client::is5xx(make_shared<int>(response_->statusCode))) {
      ...
      if (Darabonba_Util::Client::equalString(params->bodyType, make_shared<string>("binary"))) {
        shared_ptr<map<string, boost::any>> resp = make_shared<map<string, boost::any>>(map<string, boost::any>({
          {"body", !response_->body ? boost::any() : boost::any(*response_->body)},
          {"headers", boost::any(response_->headers)}
        })
      ...
      else if (Darabonba_Util::Client::equalString(params->bodyType, make_shared<string>("byte"))) {
        shared_ptr<vector<uint8_t>> byt = make_shared<vector<uint8_t>>(Darabonba_Util::Client::readAsBytes(response_->body));
        return {
          {"body", !byt ? boost::any() : boost::any(*byt)},
          {"headers", boost::any(response_->headers)}
      ...
      else if (Darabonba_Util::Client::equalString(params->bodyType, make_shared<string>("string"))) {
        shared_ptr<string> str = make_shared<string>(Darabonba_Util::Client::readAsString(response_->body));
        return {
          {"body", !str ? boost::any() : boost::any(*str)},
          {"headers", boost::any(response_->headers)}
      ...
      else if (Darabonba_Util::Client::equalString(params->bodyType, make_shared<string>("json"))) {
        shared_ptr<boost::any> obj = make_shared<boost::any>(Darabonba_Util::Client::readAsJSON(response_->body));
        shared_ptr<map<string, boost::any>> res = make_shared<map<string, boost::any>>(Darabonba_Util::Client::assertAsMap(obj));
        return {
          {"body", !res ? boost::any() : boost::any(*res)},
      ...
      else if (Darabonba_Util::Client::equalString(params->bodyType, make_shared<string>("array"))) {
        shared_ptr<boost::any> arr = make_shared<boost::any>(Darabonba_Util::Client::readAsJSON(response_->body));
        return {
          {"body", !arr ? boost::any() : boost::any(*arr)},
          {"headers", boost::any(response_->headers)}
...
map<string, boost::any> Alibabacloud_OpenApi::Client::callApi(shared_ptr<Params> params, shared_ptr<OpenApiRequest> request, shared_ptr<Darabonba_Util::RuntimeOptions> runtime) {
  ...
  if (Darabonba_Util::Client::isUnset<string>(_signatureAlgorithm) || !Darabonba_Util::Client::equalString(_signatureAlgorithm, make_shared<string>("v2"))) {
    return doRequest(params, request, runtime);
  }
  else if (Darabonba_Util::Client::equalString(params->style, make_shared<string>("ROA")) && Darabonba_Util::Client::equalString(params->reqBodyType, make_shared<string>("json"))) {
  ...
  else if (Darabonba_Util::Client::equalString(params->style, make_shared<string>("ROA"))) {
...
void Alibabacloud_OpenApi::Client::setRpcHeaders(shared_ptr<map<string, string>> headers) {
  _headers = headers;
}
