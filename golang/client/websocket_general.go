...
func (client *Client) DoGeneralWebSocketRequest(params *Params, request *OpenApiRequest, runtime interface{}, handler dara.GeneralWebSocketHandler) (*dara.DefaultWebSocketClient, error) {
